...
open class URLEmbeddedView: UIView {
    ...
    fileprivate func configureViews() {
        ...
        addLayoutSubview(linkIconView, andConstraints:
            ...
            linkIconView.left,
            linkIconView.bottom,
            linkIconView.MisterFusionWidth |==| linkIconView.MisterFusionHeight
        )
        ...
        addLayoutSubview(descriptionLabel, andConstraints:
            ...
            descriptionLabel.MisterFusionHeight |>=| 0,
        ...
        addLayoutSubview(activityView, andConstraints:
            ...
            activityView.MisterFusionWidth  |==| 30,
            activityView.MisterFusionHeight |==| 30
        )
    ...
    private func changeImageViewWidthConstrain(_ constant: CGFloat?) {
        ...
        if let constant = constant {
            misterFusion = imageView.MisterFusionWidth |==| constant
        } else {
            misterFusion = imageView.MisterFusionWidth |==| imageView.MisterFusionHeight
        }
    ...
    private func changeDomainImageViewWidthConstraint(_ constant: CGFloat?) {
        ...
        let misterFusion: MisterFusion
        if let constant = constant {
            misterFusion = domainImageView.MisterFusionWidth |==| constant
        } else {
            misterFusion = domainImageView.MisterFusionWidth |==| domainConainter.MisterFusionHeight
        }
    ...
    private func changeTitleLabelHeightConstraint() {
        ...
        titleLabelHeightConstraint = addLayoutConstraint(titleLabel.MisterFusionHeight |>=| constant)
    }
    ...
    private func changeDomainContainerHeightConstraint() {
        ...
        domainContainerHeightConstraint = addLayoutConstraint(domainConainter.MisterFusionHeight |==| constant)
    }
