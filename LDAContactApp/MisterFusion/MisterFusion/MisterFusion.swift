...
extension UIView {
    ...
    @objc(MisterFusionHeight)
    public var MisterFusionHeight: MisterFusion { return createMisterFusion(withAttribute: .height) }
    
    @objc(MisterFusionWidth)
    public var MisterFusionWidth: MisterFusion { return createMisterFusion(withAttribute: .width) }
